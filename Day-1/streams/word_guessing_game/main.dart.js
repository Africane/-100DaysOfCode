...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _ForwardingStreamSubscription$(_stream, onData, onError, onDone, cancelOnError, $S, $T) {
      var t5, t6,
        ...
        t4 = onData == null ? A.async___nullDataHandler$closure() : onData;
      type$.$env_1_1_void._bind$1($T)._eval$1("1(2)")._as(t4);
      ...
      t3 = new A._ForwardingStreamSubscription(_stream, t4, t5, type$.void_Function._as(t6), t1, t2 | t3, $S._eval$1("@<0>")._bind$1($T)._eval$1("_ForwardingStreamSubscription<1,2>"));
    ...
    main() {
      var buttonClickStream,
        t1 = document,
        button = t1.querySelector("button"),
        input = type$.nullable_InputElement._as(t1.querySelector("input"));
      if (button != null && input != null) {
        buttonClickStream = J.get$onClick$x(button);
        t1 = buttonClickStream.$ti._eval$1("_TakeStream<1>");
        new A._WhereStream(t1._eval$1("bool(1)")._as(new A.main_closure(input)), new A._TakeStream(4, buttonClickStream, t1), t1._eval$1("_WhereStream<1>")).listen$2$onDone(new A.main_closure0(), new A.main_closure1());
      }
    },
  ...
  A._TakeStream.prototype = {
    _createSubscription$4(onData, onError, onDone, cancelOnError) {
      ...
      t6 = onData == null ? A.async___nullDataHandler$closure() : onData;
      type$.$env_1_1_void._bind$1(t1)._eval$1("1(2)")._as(t6);
      ...
      t5 = new A._StateStreamSubscription(t2, _this, t6, t7, type$.void_Function._as(t8), t3, t4 | t5, type$.$env_1_1_int._bind$1(t1)._eval$1("_StateStreamSubscription<1,2>"));
      t5._ForwardingStreamSubscription$5(_this, onData, onError, onDone, cancelOnError, t1, t1);
      return t5;
    },
    _handleData$2(inputEvent, sink) {
      var count,
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      return this.input.value === "banana";
    },
    $signature: 15
  };
  ...
  (function installTearOffs() {
    ...
    _instance_2_u(_, "get$_handleError", "_handleError$2", 14);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "~(Object,StackTrace)", "~(Event)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(@,StackTrace)", "bool(Event)", "~(@)"],
